...
<p>
<a href="//themehunk.com/product/shopline-pro-multipurpose-shopping-theme/" target="_blank" class="button button-primary">Check Pro version for more features</a>
</p></div>
<?php }
...
<?php $odi_url = wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=one-click-demo-import'), 'install-plugin_one-click-demo-import'); ?>
            ...
            <?php else : ?>
              <p style="color:#e45f12;font-style:italic;font-size:14px;"><?php esc_html_e( 'Plugin installed and active!', 'shopline' ); ?></p>
...
function shopline_tab_page() {
 ...
 function shopline_plugin_api() {
  ...
  if($plugin_slug=='themehunk-customizer'){
		$detail= 'ThemeHunk customizer - ThemeHunk customizer plugin will allow you to add  unlimited number of columns for services, Testimonial, and Team 
		with widget support. It will add slider section, Ribbon section, latest post, Contact us and Woocommerce section. These will be visible on front page of your site.';
...
unlimited contact forms and to generate unlimited leads on your site.';
    ...
    $detail = 'Crelly Slider is a Free / Open Source responsive WordPress slider that supports layers. You can add Texts, Images, YouTube/Vimeo videos using a powerful Drag & Drop Builder and animate each of them.';
} elseif($plugin_slug=='one-click-demo-import'){
    $detail = 'The best feature of this plugin is, that theme authors can define import files in their themes and so all you (the user of the theme) have to do is click on the “Import Demo Data” button.';
} 
