...
Class LFB_EDIT_DEL_FORM {
    ...
    function lfbFieldTypeDefault($value,$name,$fieldID){
    ...
    // field default value
    function lfbFieldDefaultValue($fieldv,$fieldID){
    $defaultValue = isset($fieldv['default_value'])?$fieldv['default_value']:'';

    $return = '<td><input type="text" class="default_value" name="form_field_' . $fieldID . '[default_value]" id="default_value_' . $fieldID . '" value="'.$defaultValue.'">';
    ...
    $return = '<td colspan="3" ><div class="default_htmlfield_' . $fieldID . '" id="default_htmlfield"><textarea class="default_value default_htmlfield" name="form_field_' . $fieldID . '[default_value]" id="default_value_'. $fieldID . '">'.$defaultValue.'</textarea></div>';
     ...
     // field placeholder
    function lfbFieldPlaceholder($fieldv,$fieldID){
        $fieldPlaceholder = isset($fieldv['default_placeholder'])?$fieldv['default_placeholder']:'';
        $isRequired = ($fieldPlaceholder == 1 ? 'checked' : "" );
        $return = '<td><input type="checkbox" class="default_placeholder" name="form_field_' . $fieldID . '[default_placeholder]" id="default_placeholder_' . $fieldID . '" value="1" '.$isRequired.'></td>';
        return $return;
    }
...
// checkbox options
    ...
    function lfbFieldType($fieldv,$fieldID){
            $text = array('name','email','url','number','text','date','dob','upload');
